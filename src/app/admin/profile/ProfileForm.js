  ...
  return (
    <div className="bg-white rounded-3xl border border-slate-200/60 shadow-sm p-6 sm:p-8">
      ...
      <form onSubmit={handleSubmit} className="space-y-8">
              ...
              <div className="flex flex-col sm:flex-row justify-between sm:items-center gap-3">
                ...
                <div className="shrink-0">
                  ...
                  <button
                    ...
                    className="px-4 py-2.5 bg-orange-600 hover:bg-orange-500 text-white rounded-xl text-xs font-bold flex items-center gap-1.5 transition-all shadow-md shadow-orange-600/10 cursor-pointer"
                  >
                    📷 Unggah Gambar QRIS
                  </button>
                </div>
              ...
              {qrisDataState ? (
                <div className="bg-emerald-50/50 dark:bg-emerald-950/20 border border-emerald-100/50 dark:border-emerald-900/30 rounded-2xl p-4 flex justify-between items-center">
                  ...
                  <button
                    ...
                    className="px-3 py-1.5 bg-red-50 hover:bg-red-100 dark:bg-red-950/30 text-red-600 dark:text-red-400 border border-red-200/30 dark:border-red-900/30 rounded-xl text-[10px] font-bold transition-all cursor-pointer"
                  >
                    Hapus QRIS
                  </button>
                </div>
            ...
            <div className="bg-slate-50 dark:bg-slate-900 p-5 rounded-3xl border border-slate-200/50 dark:border-slate-800/50 space-y-4">
              ...
              {!showAddAccountForm ? (
                <button
                  ...
                  className="w-full py-3.5 bg-slate-100/80 hover:bg-slate-200/60 dark:bg-slate-900/50 dark:hover:bg-slate-900/80 border border-dashed border-slate-300 dark:border-slate-800 text-slate-700 dark:text-slate-300 rounded-2xl text-xs font-bold transition-all flex items-center justify-center gap-1.5 cursor-pointer hover:border-orange-500/40 hover:text-orange-600 dark:hover:text-orange-400"
                >
                ...
                <div className="bg-white dark:bg-slate-950 border border-slate-200/60 dark:border-slate-800/60 p-5 rounded-2xl space-y-4 shadow-sm animate-in fade-in slide-in-from-top-3 duration-200">
                  ...
                  <div className="flex justify-end gap-2.5 pt-2 border-t border-slate-100 dark:border-slate-800/80">
                    <button
                      ...
                      className="px-3.5 py-1.5 bg-slate-100 hover:bg-slate-200 dark:bg-slate-800 dark:hover:bg-slate-700 text-slate-600 dark:text-slate-300 rounded-xl text-xs font-bold transition-colors cursor-pointer"
                    >
                      Batal
                    </button>
                    <button
                      ...
                      className="px-4 py-1.5 bg-orange-600 hover:bg-orange-500 text-white rounded-xl text-xs font-bold shadow-md shadow-orange-600/10 transition-colors cursor-pointer"
                    >
                      Simpan Akun
                    </button>
                  </div>
        ...
        {/* Submit Button (Sticky Bottom on Mobile for Easy Saving) */}
        <div className="sticky bottom-0 left-0 right-0 p-4 -mx-4 sm:mx-0 sm:p-0 sm:relative bg-white/90 dark:bg-slate-900/90 backdrop-blur-md sm:backdrop-blur-none border-t sm:border-t-0 border-slate-200 dark:border-slate-800 z-30 flex justify-end pt-3 sm:pt-5">
          <button
            type="submit"
            disabled={isPending}
            className="w-full sm:w-auto px-6 py-3.5 sm:py-3 bg-orange-600 hover:bg-orange-500 active:scale-95 disabled:opacity-50 text-white font-bold rounded-2xl text-sm transition-all shadow-xl shadow-orange-600/20 flex items-center justify-center gap-2 cursor-pointer"
          >
            {isPending ? (
              <>
