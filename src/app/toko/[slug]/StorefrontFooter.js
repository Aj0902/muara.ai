          ...
          <div className="space-y-4">
            ...
            <div className="flex flex-col space-y-3">
              ...
              <div className="flex gap-3 pt-1">
                ...
                {(() => {
                  const isJson = store.facebook && store.facebook.startsWith('{');
                  let fbUrl = store.facebook;
                  if (isJson) {
                    try {
                      fbUrl = JSON.parse(store.facebook).facebookUrl;
                    } catch (e) {
                      fbUrl = '';
                    }
                  }
                  return fbUrl ? (
                    <a href={fbUrl} target="_blank" rel="noopener noreferrer" className="p-2 bg-slate-100 hover:bg-slate-200 dark:bg-slate-800 dark:hover:bg-slate-700 rounded-xl transition-all" title="Facebook">
