  ...
  return (
    <header className="h-20 bg-white dark:bg-slate-900 border-b border-slate-200 dark:border-slate-800 flex items-center justify-between px-8 shrink-0">
      <div className="flex items-center gap-4">
        <h1 className="text-xl font-bold text-slate-800 dark:text-white tracking-tight" id="header-title">
          {title}
        </h1>
      </div>
      ...
      <div className="flex items-center gap-4">
        ...
        <button className="relative p-2 text-slate-400 hover:text-orange-600 transition-colors bg-slate-50 hover:bg-orange-50 dark:bg-slate-800 dark:hover:bg-orange-950/20 rounded-full">
